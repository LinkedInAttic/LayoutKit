...
class PositionedLayoutTests: XCTestCase {
    ...
    func testMakeViewMultiple() {
        ...
        let layout1 = InsetLayout(insets: insets, sublayout: SizeLayout<UIView>(width: 50, height: 50) { _ in })
        let layout2 = InsetLayout(insets: insets, sublayout: SizeLayout<UIView>(width: 50, height: 50) { _ in })
